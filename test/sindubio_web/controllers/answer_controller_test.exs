defmodule SindubioWeb.AnswerControllerTest do
  use SindubioWeb.ConnCase

  alias Sindubio.Quizzes

  @create_attrs %{content: "some content", right: true, show_random: true}
  ...
  def fixture(:answer) do
    {:ok, answer} = Quizzes.create_answer(@create_attrs)
    answer
  end
